...
ja tulos taulussa `dat_ulc_comp`. Verrokkijoukko on `geos_comp`, ja painot ovat
Euroopan komission (ECFIN) kauppapainot. ficomp painotti 17 maata; tässä ovat
mukana ne 15, jotka löytyvät Eurostatista — Yhdysvallat ja Japani puuttuvat.
Painot normitetaan mukana olevien maiden kesken, joten luku on hyvin määritelty,
mutta ei numeerisesti sama kuin julkaistu 17 maan luku.
...
Tässä laskettu `nulc_aper` on sama käsite Eurostatin luvuista, joten sarjojen
pitäisi liikkua samalla tavalla. Poikkeama kertoo joko lähteiden erosta tai
laskentavirheestä.
